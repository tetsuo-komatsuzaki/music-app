...
async function main() {
  ...
  fs.writeFileSync("./baseline_v33.json", await data!.text())
  console.log(`v33 saved: evalNotes=${perf!.evaluatedNotes} pitch=${perf!.pitchAccuracy} rhythm=${perf!.rhythmAccuracy}`)
}
