...
async function main() {
  ...
  fs.writeFileSync("./baseline_v31.json", await data!.text())
  console.log(`v31 saved: evalNotes=${perf!.evaluatedNotes} pitch=${perf!.pitchAccuracy} rhythm=${perf!.rhythmAccuracy}`)
}
