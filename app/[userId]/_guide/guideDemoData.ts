...
export const ACH_AFTER: AchievementStatus = {
  ...
  achieved: true,
  // デモは直近の95点をそのまま見せる (2026-08-29 Tetsuo指定・平均表示より直感的)
  master: { recentAvg: 95, scoredCount: 5, requiredCount: 5, threshold: 90 },
...
export const HOME_DONE: HomeProps = {
  ...
  recentPieces: [{
    id: DEMO_SONG_ID, title: "きらきら星", star: 1, cover: null,
    latest: 95, recentAvg: 95, badge: "achieved", href: `#demo-${DEMO_SONG_ID}`,
  }],
  rankCard: {
