...
import { FingerboardDemo } from "@/app/components/fingerboard"
import styles from "../lessons.module.css"

export default function LessonFingerboard({ lesson }: { lesson: string }) {
  return <FingerboardDemo lesson={lesson} className={styles.fbFill} />
}
