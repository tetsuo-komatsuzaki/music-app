...
export const LESSONS: Lesson[] = [
  ...
  {
    id: "bow_staccato", name: "ボウ・スタッカート", cat: "bow", tag: tech("ボウ・スタッカート"), figType: "bow",
    ...
    terms: ["ボウ・スタッカート", "1方向のまま刻む", "よくあるまちがい", "コツ", "できたときの感覚"],
  },
  {
  ...
  {
    id: "mordent", name: "モルデント", cat: "left", tag: tech("モルデント"), figType: "fb",
    figs: [{ fingers: [[2, 1], [2, 2]] }, { fingers: [[2, 1], [2, 2]], cross: true }, { fingers: [[2, 1], [2, 2]] }],
    texts: [
      "トリルの短縮形。<b>1往復だけ</b>の飾りだよ。",
      "本体の音→となりの音→本体、を<b>すばやく1回</b>。",
      "往復が増えてトリルになってしまうのがまちがい。",
      "「<b>ワンタッチだけ</b>」と数えながら弾こう。",
      "音の頭にキラッと飾りがついたら成功!",
    ],
    terms: ["モルデント", "1往復だけ", "よくあるまちがい", "コツ", "できたときの感覚"],
  },
  {
