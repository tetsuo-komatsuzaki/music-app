...
export const HELP_CONTENT = {
  ...
  markerLegend: {
    ...
    rows: [
      ...
      { key: "red",    name: "だいだい", meaning: "音程がズレた",     detail: "楽譜と違う高さで弾いた音" },
      { key: "orange", name: "青みどり", meaning: "タイミングがズレた", detail: "楽譜より早い・遅く弾いた音" },
    ],
    note: "音程とタイミングが両方ズレた音は、だいだいで表示します。まずはだいだいから直すのが、上達への近道です。",
  },
