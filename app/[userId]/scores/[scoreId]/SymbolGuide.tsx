...
export function SymbolGlyph({ glyph, value }: { glyph: SymbolGlyphKind; value?: string }) {
  ...
  switch (glyph) {
    ...
    case "pizz": return txt("pizz.", { fontStyle: "italic", fontSize: "var(--fs-caption)" })
    ...
    case "text": return txt("dolce", { fontStyle: "italic", fontSize: "var(--fs-label)" })
    case "metronome": return txt("♩=", { fontWeight: 800, fontSize: "var(--fs-body)" })
    case "finger": return txt("2", { fontWeight: 800 })
    case "string": return txt("Ⅲ", { fontWeight: 800 })
    case "key": return txt("♯♭", { fontWeight: 800, fontSize: "var(--fs-body)" })
    case "time": return txt(value ?? "4/4", { fontWeight: 800, fontSize: "var(--fs-caption)" })
    case "accidental": return txt("♮", { fontWeight: 800, fontSize: "var(--fs-subhead)" })
    case "clef": return txt("𝄞", { fontSize: "var(--fs-head)" })
    case "ottava": return txt("8va", { fontStyle: "italic", fontSize: "var(--fs-label)", fontWeight: 800 })
    ...
    case "segno": return txt("𝄋", { fontSize: "var(--fs-subhead)" })
    ...
    case "timeC": return txt("C", { fontFamily: "Georgia,serif", fontWeight: 800, fontSize: "var(--fs-subhead)" })
    case "ritard": return txt("rit.", { fontStyle: "italic", fontSize: "var(--fs-label)", fontWeight: 800 })
    ...
    case "arco": return txt("arco", { fontStyle: "italic", fontSize: "var(--fs-label)" })
    case "sulpont": return txt("s.p.", { fontStyle: "italic", fontSize: "var(--fs-caption)" })
    case "sultasto": return txt("s.t.", { fontStyle: "italic", fontSize: "var(--fs-caption)" })
    case "collegno": return txt("legno", { fontStyle: "italic", fontSize: "var(--fs-label)" })
    ...
    case "doubleacc": return txt("𝄪", { fontWeight: 800, fontSize: "var(--fs-subhead)" })
    case "quarter": return txt("♯½", { fontWeight: 800, fontSize: "var(--fs-caption)" })
    case "lyric": return txt("La", { fontSize: "var(--fs-body)", fontWeight: 700 })
    case "enharmonic": return txt("♯=♭", { fontWeight: 800, fontSize: "var(--fs-label)" })
    case "finger_sub": return txt("2-3", { fontWeight: 800, fontSize: "var(--fs-label)" })
