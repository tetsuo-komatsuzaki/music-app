...
const COPY_TECH: Record<TechId, Triple> = {
  ...
  bow_staccato: {
    a: ["いつもは難しい連続スピッカート、今日は一弓できれいに刻めてたね！", "苦手だった連続スピッカート、今日は刻みが安定していたね。"],
    c: ["連続スピッカート、前よりきれいに刻めてきたね！", "連続スピッカートの刻み、上向きだね。"],
    b: ["今日は連続スピッカート、一弓できれいに刻めてたね！", "連続スピッカート、今日はそろって決まっていたね。"],
  },
  tremolo: {
