...
export const OBSERVATION_CATALOG: ObservationCategory[] = [
  {
    ...
    tags: [
      ...
      { id: "posture_other", label: "その他（コメントに記入）" },
    ],
  },
  {
    ...
    tags: [
      ...
      { id: "bow_other", label: "その他（コメントに記入）" },
    ],
  },
  {
    ...
    tags: [
      ...
      { id: "left_other", label: "その他（コメントに記入）" },
    ],
  },
  {
    ...
    tags: [
      ...
      { id: "pitch_other", label: "その他（コメントに記入）" },
    ],
  },
  {
    ...
    tags: [
      ...
      { id: "rhythm_other", label: "その他（コメントに記入）" },
    ],
  },
  {
    ...
    tags: [
      ...
      { id: "tone_other", label: "その他（コメントに記入）" },
    ],
  },
  {
    ...
    tags: [
      ...
      { id: "habit_other", label: "その他（コメントに記入）" },
    ],
  },
]
