...
export const SUB_TASK_NAMES: Record<SubTaskId, string> = {
  ...
  pitch_interval_up_2nd_plus: "すぐ上の音をとるの音程",
  pitch_interval_up_3rd_plus: "離れた上の音をとる・3度以上の音程",
  pitch_interval_down_2nd_plus: "すぐ下の音をとるの音程",
  pitch_interval_down_3rd_plus: "離れた下の音をとる・3度以上の音程",
  pitch_finger_1: "人差し指・1指の音程",
  pitch_finger_2: "中指・2指の音程",
  pitch_finger_3: "薬指・3指の音程",
  pitch_finger_4: "小指・4指の音程",
  // ─── リズム ───
  ...
  bowing_string_g: "G線・Ⅳの音色",
  bowing_string_d: "D線・Ⅲの音色",
  bowing_string_a: "A線・Ⅱの音色",
  bowing_string_e: "E線・Ⅰの音色",
