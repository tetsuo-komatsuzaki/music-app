...
export const ARTICULATIONS = [
  ...
  // 2026-09-05 Tetsuo確定: 連続スピッカート (サルタート・跳ねさせる弓) = 選んだ音符をすべてスラーでつなぎ、点を付ける。
  // 表記は「スタッカートの点」だが奏法はスピッカート系。旧称「連続スタッカート」は 2026-09-05 に改名
  // スラーの中のスタッカート点は解析側でも「連続スピッカート」の技術タグになる。生成側 (_ART_CLS "bow_staccato") と揃える
