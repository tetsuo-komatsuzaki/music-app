...
await warm.goto("http://localhost:3100/dev/treasure-demo/demo?s=medal", { waitUntil: "domcontentloaded", timeout: 180000 })
...
await page.goto("http://localhost:3100/dev/treasure-demo/demo?s=medal", { waitUntil: "domcontentloaded", timeout: 180000 })
await page.waitForSelector("text=うけとる", { timeout: 30000 })
